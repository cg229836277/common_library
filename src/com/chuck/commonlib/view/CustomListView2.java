...
// * @version 1.0
// */
//public class CustomListView2 extends ListView implements OnScrollListener {
//
//	/**  显示格式化日期模板   */
...
//
//	public CustomListView2(Context pContext, AttributeSet pAttrs) {
//		super(pContext, pAttrs);
//		init(pContext);
//	}
//
//	public CustomListView2(Context pContext) {
//		super(pContext);
//		init(pContext);
//	}
//
//	public CustomListView2(Context pContext, AttributeSet pAttrs, int pDefStyle) {
