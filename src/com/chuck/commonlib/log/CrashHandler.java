...
import com.chuck.commonlib.util.http.HttpContentType;
 ...
 */  
public class CrashHandler implements UncaughtExceptionHandler , HttpRequestCallBackListenner{  
    /** Debug Log Tag */  
    ...
    private static HttpRequestUtil listenner;
...
//            mDeviceCrashInfo.store(trace, null);    
    ...
    private void postReport(File file) {  
    	if(FileUtil.isFileExist(file, false) && !StringUtil.isEmpty(uploadLogFileUrl)){  		
    		try {
				HttpRequestUtil.postFile(uploadLogFileUrl, file.getAbsolutePath(), HttpContentType.MEDIA_TYPE_TXT , "crash_file" , new HttpRequestCallBackListenner() {
